...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-10-2024 a las 02:10:09
...
ALTER TABLE
  `user_pokemon`
ADD
  CONSTRAINT `user_pokemon_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`_id`) ON DELETE CASCADE,
ADD
  CONSTRAINT `user_pokemon_ibfk_2` FOREIGN KEY (`pokemon_id`) REFERENCES `pokemon` (`_id`) ON DELETE CASCADE;
